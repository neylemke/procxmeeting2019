 ...
 \title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{ Introns and homing endonucleases shape mitochondrial genomes of fungal species from Hypocreales order (Ascomycota) }} % Article title
